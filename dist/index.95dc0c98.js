...
})({"1GIaj":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "69e5b2ed95dc0c98";
"use strict";
...
},{}],"3JUqx":[function(require,module,exports,__globalThis) {
...
(async function() {
    ...
    // Aggregate data to count ratings
    const ratingsCount = {};
    data.forEach(({ Rating })=>{
        ratingsCount[Rating] = (ratingsCount[Rating] || 0) + 1;
    });
    // Convert aggregated data to arrays
    const labels = Object.keys(ratingsCount); // Ratings (e.g., 1, 2, 3, 5)
    const counts = Object.values(ratingsCount); // Count of each rating
    // Create the chart
    new (0, _autoDefault.default)(document.getElementById("ratings"), {
        type: "bar",
        data: {
            labels: labels,
            datasets: [
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    callbacks: {
                        label: (context)=>`Rating ${context.label}: ${context.raw} votes`
                    }
                }
            },
            scales: {
...
},{}]},["1GIaj","3JUqx"], "3JUqx", "parcelRequire94c2")

//# sourceMappingURL=index.95dc0c98.js.map
